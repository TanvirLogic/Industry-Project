      ...
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          decoration: InputDecoration(
            ...
            enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(15), borderSide: const BorderSide(color: Color(0xFFEFEFF0), width: 1)),
            focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(15), borderSide: BorderSide(color: cs.primary, width: 1.5)),
            errorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(15), borderSide: const BorderSide(color: Color(0xFFEF4444), width: 1.5)),
            focusedErrorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(15), borderSide: const BorderSide(color: Color(0xFFEF4444), width: 1.5)),
                    ...
                    Expanded(
                      child: Theme(
                        data: Theme.of(context).copyWith(
                          colorScheme: ColorScheme(brightness: cs.brightness, primary: cs.primary, onPrimary: cs.onPrimary, secondary: cs.secondary, onSecondary: cs.onSecondary, error: cs.error, onError: cs.onError, surface: cs.surface, onSurface: cs.onSurface),
                        ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: scBg, borderRadius: BorderRadius.circular(15),
          border: Border.all(color: isSelected ? cs.primary : const Color(0xFFEFEFF0), width: 2),
        ),
        child: Row(children: [
          Icon(isSelected ? Icons.radio_button_checked : Icons.radio_button_off, color: isSelected ? cs.primary : cs.onSurface.withValues(alpha: 0.5)),
